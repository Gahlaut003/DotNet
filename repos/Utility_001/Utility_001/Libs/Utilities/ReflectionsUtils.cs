...
namespace Utility_001.Libs.Utilities
{
    public static class ReflectionsUtils
    {
        ...
        public static object StringToTypedValue(string sourceString, Type targetType, CultureInfo culture = null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    throw (new InvalidCastException("Type Conversion not handled in StringToTypedValue for" + targetType.Name));
                }
            }
        ...
        {
            return Object.GetType().GetField(Property, ReflectionsUtils.MemberAccess | BindingFlags.GetField).GetValue(Object);
        }
        private static object GetPropertyInternal(object Parent, string Property)
        {
            ...
            MemberInfo member = Parent.GetType().GetMember(pureProperty, ReflectionsUtils.MemberAccess)[0];
        ...
        public static PropertyInfo GetPropertyInfoInternal(object Parent, string Property)
        {
            ...
            // Get the member
            return Parent.GetType().GetProperty(propertyName, ReflectionsUtils.MemberAccess);
        }
        public static void SetProperty(object obj, string property, object value)
        {
            obj.GetType().GetProperty(property, ReflectionsUtils.MemberAccess).SetValue(obj, value, null);
        }
        public static void SetField(object obj, string property, object value)
        {
            obj.GetType().GetField(property, ReflectionsUtils.MemberAccess).SetValue(obj, value);
        }
        ...
        public static object CallMethod(object instance, string method, Type[] parameterTypes, params object[] parms)
        {
            if (parameterTypes == null && parms.Length > 0)
                return instance.GetType().GetMethod(method, ReflectionsUtils.MemberAccess | BindingFlags.InvokeMethod).Invoke(instance, parms);
            else
                return instance.GetType().GetMethod(method, ReflectionsUtils.MemberAccess | BindingFlags.InvokeMethod, null, parameterTypes, null).Invoke(instance, parms);
        }
        ...
        public static object CallMethodEx(object parent, string method, params object[] parms)
        {
            ...
            if (lnAt < 0)
            {
                return ReflectionsUtils.CallMethod(parent, method, parms);
            }
        ...
        {
            return instance.GetType().GetProperty(property, ReflectionsUtils.MemberAccess).GetValue(instance, null);
        }
        ...
        {
            return instance.GetType().InvokeMember(property, ReflectionsUtils.MemberAccessCom | BindingFlags.GetProperty, null,
                                                instance, null);
        }
        public static object GetPropertyExCom(object parent, string property)
        {
            ...
            if (lnAt < 0)
            {
                ...
                // Get the member
                return parent.GetType().InvokeMember(property, ReflectionsUtils.MemberAccessCom | BindingFlags.GetProperty, null,
                    parent, null);
            }
            string Main = property.Substring(0, lnAt);
            string Subs = property.Substring(lnAt + 1);

            object Sub = parent.GetType().InvokeMember(Main, ReflectionsUtils.MemberAccessCom | BindingFlags.GetProperty, null,
                parent, null);
            return ReflectionsUtils.GetPropertyExCom(Sub, Subs);
        }
        public static void SetPropertyCom(object inst, string Property, object Value)
        {
            inst.GetType().InvokeMember(Property, ReflectionsUtils.MemberAccessCom | BindingFlags.SetProperty, null, inst, new object[1] { Value });
        }
        public static object SetPropertyExCom(object parent, string property, object value)
        {
            ...
            {
                // Set the member
                parent.GetType().InvokeMember(property, ReflectionsUtils.MemberAccessCom | BindingFlags.SetProperty, null,
        ...
        {
            return instance.GetType().InvokeMember(method, ReflectionsUtils.MemberAccessCom | BindingFlags.InvokeMethod, null, instance, parms);
        }
        public static object CallMethodExCom(object parent, string method, params object[] parms)
        {
            ...
            if (at < 0)
            {
                return ReflectionsUtils.CallMethodCom(parent, method, parms);
            }
